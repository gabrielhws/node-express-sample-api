...
module.exports = {
    whitelist: [
        'http://beta_domain.com',
        'http://localhost:your_port',
        'https://prerender.io'
    ],
    database: {
        host: process.env.MONGO_URL || 'your_db_beta_IP',
        database: process.env.MONGO_DB || 'your_beta_db_project_name',
        user: process.env.MONGO_USER || 'your_beta_user',
        password: process.env.MONGO_PASS || 'your_beta_pw'
    },
    log4js: {
        appenders: {
